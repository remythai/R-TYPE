 ...
 * @tparam Component The component type to store (e.g. `Transform`, `RigidBody`).
 */
...
class SparseSet {
    public:
        ...
        *
        * Maintains array compactness by moving the last element into the erased position.
        *
    ...
    private:
        ...
        /// @brief Stores component data in the same order as `dense` for fast iteration.
