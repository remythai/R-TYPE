...
namespace GameEngine {
    /**
     * @class DomainHandler
     * @brief System that manages entity domains and destroys entities outside their boundaries.
     *
     * The DomainHandler is an ECS system that monitors entities with Position and Domain components.
     * It automatically destroys any entity that moves outside the boundaries defined by its Domain component.
     *
     ...
     *
     * @details
     * The system iterates through all entities that have both Position and Domain components.
     * For each entity, it checks if the position (pos.x, pos.y) is within the domain boundaries:
     ...
     *
     * @note This system requires entities to have both Position and Domain components to be processed.
     * @see Position
     * @see Domain
     */
    ...
    public:
        /**
         * @brief Constructs the DomainHandler system and sets up component requirements.
         *
         * This constructor registers the Position and Domain components as requirements
         * for the system to be active and process entities.
         *
         * @post The system is configured to only process entities with Position and Domain components.
         */
        DomainHandler() {
        ...
        /**
         * @brief Updates the system, checking entity positions against their domain boundaries.
         *
         ...
         *
         * @param registry Reference to the main ECS registry for entity and component access.
         ...
         *
         * @note Destroying entities during iteration is safe because the system uses
         *       the smallest pool for optimization, which doesn't invalidate iterators
