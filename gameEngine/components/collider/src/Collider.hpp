    ...
    namespace GameEngine
{
     ...
     * - Actual collision bounds: `[pos + translation, pos + translation +
     * size]`
     *
     * **Layer System (8-bit):**
    ...
    struct Collider : public Component<Collider>
    {
         ...
         * Useful for fine-tuning hit detection (e.g., excluding decorative
         * parts).
         */
         ...
         * with.
         *
         * Collision occurs when: `(thisEntity.selector & otherEntity.diff) !=
         * 0` Enables one-way collisions and layer-based filtering.
         */
        ...
        Collider(
            ...
            std::bitset<8> val_diff = std::bitset<8>(0),
            vec2 val_size = vec2(0, 0))
