...
void rtype::NetworkServer::initECS()
{
    ...
    std::cout
        << "[SERVER] ECS initialized with InputHandlerSystem and MotionSystem"
        << std::endl;
}
...
EntityManager::Entity rtype::NetworkServer::createPlayerEntity(uint8_t playerId)
{
    ...
    _registry->emplace<GameEngine::Renderable>(
        entity, 1920.0f, 1080.0f, "assets/sprites/r-typesheet42.png", rectPos,
        vec2{33.2f, 17.2f}, 1000, false);
